        ...
        <div id="fullpage-wrapper">
          ...
          <div className="section">
            <div className="slide">
              ...
              <p className="cp-text">J'ai ensuite eu l'incroyable chance de déménager et de m'enraciner dans l'une des plus belles régions de France : LA LORRAINE.</p>
            ...
            <div className="slide">
              ...
              <p className="cp-text">C'est là-bas que j'ai fait mon primaire, collège, lycée.</p>
              <p className="cp-text">J'ai appris à faire pleins de choses dans les champs et les forêts, jeune : des pures cabanes et plus vieux des pures soirées.</p>
            ...
            <div className="slide">
              ...
              <p className="cp-text">Il faut croire que le froid tue le virus..(un site qui dénonce ici)</p>
