      ...
      return (
        <div id="fullpage-wrapper">
          <div className="section">
            ...
            <p className="cp-text">J'ai eu la chance d'avoir plusieurs expériences professionnelles ou associatives à
              côté de mes études</p>
          ...
          <div className="section">
            <div className="slide">
              ...
              <p className="cp-text">En plus de gagner un peu d'argent, cela m'apprend à travailler avec des clients
                ainsi que monter en compétences</p>
              <p className="cp-text">Actuellement je travaille pour une startup de mesure de qualité de l'air</p>
              <p className="cp-text">Je développe une application sous react native, elle permet de faire les relevés
                avec des capteurs et de les partager</p>
              <Img className="cp-big-image" style={{width: "150px"}}
            ...
            <div className="slide">
              ...
              <p className="cp-text">J'ai réalisé mon TN09 chez Amadeus à Sofia Antipolis</p>
              <p className="cp-text">Ma mission était de refaire une application qui est devenue trop vieille pour être
                maintenue</p>
              <p className="cp-text">J'ai dû donc faire un retro-engineering de l'ancienne, une maquette de la prochaine
                application ainsi qu'un choix pour les technologies</p>
              <p className="cp-text">J'ai développé l'application côté front-end sous Angular et je suis en train de
                finir le back-end sous Spring</p>
              <p className="cp-text">Ce stage a été ma première expérience dans une grosse société avec un système
                d'information aussi complexe</p>
            </div>
            <div className="slide">
              <h1 className="cp-title">Expérience pro : stage de fin de DUT</h1>
              <p className="cp-text">J'ai réalisé mon stage de fin de DUT dans une équipe de recherche en robotique du
                LORIA (INRIA)</p>
              <p className="cp-text">J'ai découvert là-bas le monde de la recherche ainsi que le framework ROS</p>
              <p className="cp-text">J'ai travaillé là-bas sur des drones (les intels aero pour vous donner une
                idée)</p>
              <p className="cp-text">L'objectif était de faire de la navigation autonome en sous-terrain (donc sans GPS)
                en se basant sur des algos d'odométrie</p>
          ...
          <div className="section">
            <div className="slide">
              ...
              <p className="cp-text">Le principe est simple : des équipes de 6 de tous les IUT de France et 3 épreuves
                de 8h : web, IA et sécurité</p>
              <p className="cp-text">C'est là que j'ai appris à travailler dans le rush et même si ce n'était que 24h
                j'ai vraiment beaucoup appris</p>
              <p className="cp-text">Avec mon équipe nous sommes arrivés 3ème au classement général, une belle perf
                comme on dit dans le milieu</p>
            </div>
            <div className="slide">
              ...
              <p className="cp-text">L'expérience fut vraiment super, le point fort était que nous n'étions pas que avec
                des DUT donc nous avons pu beaucoup échanger!</p>
            </div>
          </div>
          <div className="section">
            <div className="slide">
              ...
              <p className="cp-text">Plaisir de rencontrer de nouvelles personnes et participer au foyer que j'aime
                tant</p>
              <p className="cp-text">Le Covid n'a rien simplifié mais avec Max et Gugus nous avons réalisé pleins de
                trucs trop cool!</p>
              <p className="cp-text">Meilleure expérience asso de loin!</p>
            </div>
            <div className="slide">
