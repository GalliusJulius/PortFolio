        ...
        <div id="fullpage-wrapper">
          ...
          <div className="section">
            ...
            <div className="slide">
              ...
              <p className="cp-text">L'objectif était de faire de la navigation autonome en sous-terrain (donc sans GPS) en se basant sur des alogs d'odométrie</p>
          ...
          <div className="section">
            <div className="slide">
              ...
              <p className="cp-text">C'est la que j'ai appris à travailler dans le rush et meme si ce n'était que 24h j'ai vraiment appris beaucoup</p>
              <p className="cp-text">Avec mon équipe nous sommes arrivé 3eme au classement général, une belle perf comme on dit dans le milieu</p>
            </div>
            <div className="slide">
              <h1 className="cp-title">Expérience : la nuit de l'informatique</h1>
              <p className="cp-text">Meme genre que les 24h des IUT mais dans toute la france</p>
              <p className="cp-text">L'expérience fut vraiment super, le point fort était que nous n'étions pas que avec des DUT donc nous avions pu beaucoup échanger!</p>
            </div>
          </div>
          <div className="section">
            <div className="slide">
